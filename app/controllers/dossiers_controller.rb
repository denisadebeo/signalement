class DossiersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @dossier.save
        format.html { redirect_to dossier_url(@dossier), notice: "Dossier was successfully created." }
  ...
  def update
    respond_to do |format|
      if @dossier.update(dossier_params)
        format.html { redirect_to dossier_url(@dossier), notice: "Dossier was successfully updated." }
  ...
  private
    ...
    def dossier_params
      params.require(:dossier).permit(:titre, :categorie, :user_id, :status)
    end
end
